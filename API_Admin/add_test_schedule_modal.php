<!-- update_modal.php -->
<div class="modal fade" id="Add_test_schedule_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-body">
        <form action="add_schedule.php" method="POST">
          <div class="form-group">
            <label for="firstname">Test_Schedule_ID</label>
            <input type="text" name="test_schedule_ID" class="form-control">
          </div>
          <div class="form-group">
