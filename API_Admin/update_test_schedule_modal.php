<!-- update_modal.php -->
<div class="modal fade" id="update_modal_<?php echo $fetch['test_Schedule_ID'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-body">
        <form action="update_test_schedule.php" method="POST">
          ...
          <div class="form-group">
            ...
            <input type="text" name="Lecturers" class="form-control" value="<?php echo $fetch['Lecturers_ID'] ?>">
          </div>
          <div class="form-group">
